...
using FinalSis457Mhmt.Models;
using Microsoft.AspNetCore.Authorization;

namespace FinalSis457Mhmt.Controllers
{
    [Authorize]
    public class SeriesController : Controller
    {
        private readonly FinalSis457MhmtContext _context;

        public SeriesController(FinalSis457MhmtContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FinalSis457MhmtContext.Series'  is null.");
            }
            var serie = await _context.Series.FindAsync(id);
            if (serie != null)
            {
